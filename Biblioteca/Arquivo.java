...
import Biblioteca.EstruturasDeDados.HashExtensivel;
import Biblioteca.EstruturasDeDados.IndiceDeExcluidos;
import Biblioteca.EstruturasDeDados.Tuplas.ParIDEndereco;
import Biblioteca.EstruturasDeDados.Tuplas.Tuple;

public abstract class Arquivo<T extends Registro> {
	...
	public abstract int SortList(List<T> list);
